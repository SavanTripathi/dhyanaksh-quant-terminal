...
export const MultiChartGrid: React.FC<MultiChartGridProps> = ({
  ...
  // 1x2 Dual View (Left/Top: Weekly 1W, Right/Bottom: Daily 1D)
  if (layout === '1x2') {
    return (
      <div className="w-full h-full grid grid-cols-2 gap-1 bg-[#2a2e39]/30">
        {/* Left Pane: Weekly (1W) */}
        <div className="relative flex flex-col h-full border-r border-[#2a2e39]/60">
  ...
  return (
    <div className="w-full h-full grid grid-cols-2 grid-rows-2 gap-1 bg-[#2a2e39]/30">
      {/* Pane 1: Quarterly (3M) */}
      <div className="relative flex flex-col h-full border-r border-b border-[#2a2e39]/60">
      ...
      {/* Pane 2: Monthly (1M) */}
      <div className="relative flex flex-col h-full border-b border-[#2a2e39]/60">
